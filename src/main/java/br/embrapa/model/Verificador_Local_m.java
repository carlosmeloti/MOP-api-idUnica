...
public class Verificador_Local_m {
	...
	public CadMaterial getCdMaterial1() {
		return cdMaterial1;
	}

	public void setCdMaterial1(CadMaterial cdMaterial1) {
		this.cdMaterial1 = cdMaterial1;
	}

	public CadMaterial getCdMaterial2() {
		return cdMaterial2;
	}

	public void setCdMaterial2(CadMaterial cdMaterial2) {
		this.cdMaterial2 = cdMaterial2;
	}

	public CadMaterial getCdMaterial3() {
		return cdMaterial3;
	}

	public void setCdMaterial3(CadMaterial cdMaterial3) {
		this.cdMaterial3 = cdMaterial3;
	}
